          ...
          <div class="card-body">
            <div class="container-fluid">
              <div class="col-lg-12 col-9">
                <div class="container">
                  <img src="<?php echo base_url('assets/images/kominfo.png')?>" width="120px" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8; display: block; margin: auto;">
