  ...
  <aside class="main-sidebar sidebar-dark-info elevation-4">
    ...
    <a href="<?= site_url('admin/dashboard/index') ?>" class="brand-link">
      <img src="<?= base_url('assets/images') ?>/100.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php $side_repositori = array('repositori-index','repositori-add') ?>
          <li class="nav-item <?php if(in_array($sidebar, $side_repositori)){echo 'menu-open';}?>">
            <a href="#" class="nav-link <?php if(in_array($sidebar, $side_repositori)){echo 'active';}?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= site_url('admin/repositori/index') ?>" class="nav-link <?php if($sidebar==$side_repositori[0]){echo 'active';} ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Table</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= site_url('admin/repositori/add') ?>" class="nav-link <?php if($sidebar==$side_repositori[1]){echo 'active';} ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add</p>
                </a>
              </li>
